...
import SalesInvoiceController.SalesInvoiceController;
 ...
 * @author DELL
 */
public class SalesInvoiceStructure extends javax.swing.JFrame {

    /**
     * Creates new form SalesInvoiceFrame
     */
    public SalesInvoiceStructure() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalesInvoiceStructure.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SalesInvoiceStructure frame = new SalesInvoiceStructure();
    ...
    private SalesInvoiceController listener = new SalesInvoiceController(this);
    public static SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");
    private ArrayList<InvoiceTable> invoices;
    private InvoiceHeader headerTableModel;
    ...
    public InvoiceHeader getHeaderTableModel() {
        return headerTableModel;
    }

    public void setHeaderTableModel(InvoiceHeader headerTableModel) {
    ...
    public SalesInvoiceController getListener() {
        return listener;
    }
